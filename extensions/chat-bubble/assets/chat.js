    ...
    API: {
      ...
      streamResponse: async function(userMessage, conversationId, messagesContainer) {
        ...
        try {
          ...
          const streamUrl = 'https://shp-mcp-poc.vercel.app/chat';
      ...
      fetchChatHistory: async function(conversationId, messagesContainer) {
        try {
          ...
          const historyUrl = `https://shp-mcp-poc.vercel.app/chat?history=true&conversation_id=${encodeURIComponent(conversationId)}`;
    ...
    Auth: {
      ...
      startTokenPolling: function(conversationId, messagesContainer) {
        ...
        const poll = async () => {
          ...
          try {
            const tokenUrl = 'https://shp-mcp-poc.vercel.app/auth/token-status?conversation_id=' +
